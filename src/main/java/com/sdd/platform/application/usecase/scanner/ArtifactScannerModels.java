...
public final class ArtifactScannerModels {
        ...
        public enum ArtifactScanMode {
                FULL, TICKET_SCOPED
        }

        public enum ArtifactScanTriggerType {
                MANUAL, BATCH, WEBHOOK
        }

        public enum ArtifactScanStatus {
                FOUND, MISSING, INACCESSIBLE, ERROR, SKIPPED
        }
        ...
        public record TicketArtifactEvidence(
                        UUID artifactTypeId,
                        String artifactTypeCode,
                        String defaultFileName,
                        boolean existsFlag,
                ...
                public boolean parseable() {
                        return existsFlag && Boolean.TRUE.equals(schemaValid);
                }
        }

        public record TicketPhaseEvaluation(
                        UUID ticketId,
                        UUID phaseId,
                        String phaseCode,
                        String status,
