...
|---|---|---|---|
| UM-DELETED-001 | inactive/deactivated account | Deleted-state/login-negative behavior | Cannot login; can be reactivated. |
| UM-COMPAT-001 | existing LOGIN-compatible active account | LOGIN regression | Active account can login after being created/updated here. |
| UM-COMPAT-002 | existing LOGIN-compatible inactive account | LOGIN regression | Inactive account cannot login. |

## Test Data to Test Case Mapping

| test data ID | used by case IDs |
|---|---|
| `admin_bb@example.test` | BB-UM-001, BB-UM-008..BB-UM-026 |
| `viewer_bb@example.test` / `editor_bb@example.test` | BB-UM-002, BB-UM-003 |
| UM-NORMAL-001 | BB-UM-001, BB-UM-008, BB-UM-014, BB-UM-021 |
| UM-NORMAL-002 | BB-UM-004, BB-UM-005, BB-UM-006, BB-UM-007 |
| UM-NORMAL-003 | BB-UM-018, BB-UM-021 |
| UM-NORMAL-004 | BB-UM-013, BB-UM-015, BB-UM-017 |
| ERR-* rows | BB-UM-009..BB-UM-020, BB-UM-024 |
| BND-* rows | BB-UM-009, BB-UM-011, BB-UM-022, BB-UM-023, BB-UM-025 |
| UM-DELETED-001 | BB-UM-018, BB-UM-021, BB-UM-025 |
