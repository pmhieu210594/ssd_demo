...
- **Migration** (`EDCAP_BE/src/main/resources/db/migration/V516__blackbox_coverage_schema.sql`) thêm mới 4 bảng blackbox (`tbl_fact_blackbox_case`, `_case_ac`, `_observation_point`, `_case_observation`), tách biệt hoàn toàn khỏi bảng AC-Test Coverage cũ.
...
| --- | --- | --- |
| `V516__blackbox_coverage_schema.sql` | Đọc code tĩnh | Đạt — chỉ thêm bảng mới, có index theo ticket_id, không đụng bảng AC-Test Coverage cũ |
