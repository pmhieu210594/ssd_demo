...
_Tóm tắt:_ Thêm schema additive `V515` (4 bảng blackbox), port/adapter persistence riêng
...
| file | summary | reason |
|---|---|---|
| `EDCAP_BE/src/main/resources/db/migration/V515__blackbox_coverage_schema.sql` | Thêm 4 bảng blackbox additive | Lưu design/execution evidence tách biệt AC-Test Coverage |
