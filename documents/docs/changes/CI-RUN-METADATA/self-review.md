...
- The next likely review comment is about whether AC-12 / AC-13 should be explicitly marked N/A or converted to a separate follow-up ticket.
- The next likely data review question is whether legacy columns `external_ci_run_id`, `pr_id`, and `finished_at` should be formally deprecated in a later migration.
